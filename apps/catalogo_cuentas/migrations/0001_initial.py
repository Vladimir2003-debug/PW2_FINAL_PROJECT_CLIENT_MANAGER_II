    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.UUIDField(blank=True, default=uuid.UUID('da20c8d9-9396-4d78-be08-b4ebdd5fca7e'))),
                ('contador', models.UUIDField(blank=True, default=uuid.UUID('aa259f40-6ce9-42db-b71b-b37c31a7b89b'))),
